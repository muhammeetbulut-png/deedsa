        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 18px;">
                ...
                <div class="modal-body px-4 py-4">
                    <div class="mb-3">
                        <label class="field-label mb-2">API ANAHTARINIZ (AIzaSy... İLE BAŞLAR)</label>
                    ...
                    <div class="p-3 bg-light rounded-3 border mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="small text-secondary">Henüz geçerli bir Gemini API anahtarınız yok mu?</span>
    ...
    <script>
        ...
        function modalSaveApiKey() {
            ...
            if (!val.startsWith('AIzaSy')) {
                alert('UYARI: Google Gemini API anahtarları "AIzaSy" ile başlamalıdır. Lütfen geçerli bir anahtar giriniz.');
                return;
            }
        ...
        async function processRobomQuery(userQuery) {
            ...
            if (!apiKey) {
                chat.innerHTML += `<div class="chat-msg robom">⚠️ Üst menüdeki <strong>"Gemini API"</strong> menüsünden AIzaSy ile başlayan anahtarınızı kaydedin.</div>`;
                chat.scrollTop = chat.scrollHeight;
                return;
            }
...
async def execute_gemini_request(http_client: httpx.AsyncClient, api_key: str, payload: dict) -> str:
    if not api_key.startswith("AIzaSy"):
        raise Exception("Geçersiz API Anahtarı! Google Gemini anahtarınız 'AIzaSy' ile başlamalıdır. Lütfen Google AI Studio üzerinden aldığınız anahtarı girin.")

    # Stabil ve aktif çalışan modeller
    target_models = [
        "gemini-2.0-flash",
        "gemini-1.5-flash",
