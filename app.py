                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-7">
                        ...
                        <select id="category" class="form-select form-select-pro">
                            ...
                            <option value="Camera Accessories">Camera Aksesuarları</option>
    ...
    <main class="container py-5 view-section" id="viewWhyNamecheap">
        <div class="row justify-content-center"><div class="col-lg-10"><div class="content-card">
            ...
            <div class="info-grid">
                ...
                <div class="info-card-box"><h5><i class="fa-solid fa-clock text-info"></i> Karar sürtünmesini azalt</h5><p>Tek single bir net CTA, kullanıcıyı gereksiz yönlendirmelerden kurtarır.</p></div>
