...
<body>
                ...
                <div class="modal-body px-4 py-4">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" id="modalApiKeyInput" class="form-control search-input" placeholder="AQ... veya AIzaSy..." style="font-family: monospace;">
    ...
    <script>
        ...
        // DOĞRUDAN TARAYICIDAN GEMINI API İSTEĞİ (SIFIR SUNUCU HATASI)
