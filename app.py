...
<body>
                ...
                <div class="content-card">
                    ...
                    <div class="info-grid">
                        <div class="info-card-box">
                            ...
                            <p>Keşfedilen .com varlığının Instagram, X (Twitter) ve TikTok platformlarında aynı kullanıcı adıyla (handle) kullanılabilir olup olmadığını anında tarar.</p>
                        </div>
                        <div class="info-card-box">
                            <h5><i class="fa-solid fa-palette text-info"></i> 2. Logo & Mockup Motoru</h5>
                            <p>Metin halindeki alan adını vektörel bir SVG kurumsal kimliğe ve gerçekçi 3D e-ticaret ambalaj kutusuna giydirir.</p>
                        </div>
                        <div class="info-card-box">
                            <h5><i class="fa-solid fa-file-lines text-warning"></i> 3. E-Ticaret Pitchbook</h5>
                            <p>Hedeflenen niş pazar için tüketici persona profili, ilk 90 günlük performans pazarlama bütçe dağılımı ve iş planı simülasyonu üretir.</p>
                        </div>
                        <div class="info-card-box">
                            <h5><i class="fa-solid fa-envelope-open-text text-danger"></i> 4. Outbound Pitch Generator</h5>
                            <p>Tescil ettiğiniz alan adını Sedo veya ikincil pazarlarda satabilmeniz için B2B teklif e-postaları kurgular.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="content-card">
                    ...
                    <p class="corporate-subtitle">Sıradan alan adı siteleri yalnızca domainin dolu olup olmadığını söyler. DeedSa, yüksek ticari potansiyelli 2 kelimelik kombinasyonları canlı root DNS ile anlık doğrular.</p>
                </div>
            </div>
        </div>
    </main>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="content-card">
                    ...
                    <p class="corporate-subtitle">Robom, DeedSa platformunda alan adı yatırımcılarına ve e-ticaret girişimcilerine rehberlik etmek üzere özel olarak eğitilmiş akıllı asistandır.</p>
                </div>
            </div>
        </div>
    </main>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="content-card">
                    ...
                    <p class="corporate-subtitle">Namecheap, ömür boyu ücretsiz WhoisGuard gizliliği ve en uygun kayıt fiyatlarıyla global lider tescil operatörüdür.</p>
                </div>
            </div>
        </div>
    </main>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="content-card">
                    ...
                    <h1 class="corporate-title">Neden <span>Sedo.com</span>?</h1>
                    <p class="corporate-subtitle">Sedo, dünyanın en büyük alan adı borsasıdır. Tescil ettiğiniz değerli .com alan adlarını SedoMLS ağı ile küresel vitrine çıkarabilirsiniz.</p>
                </div>
            </div>
        </div>
    </main>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="content-card">
                    ...
                    <h1 class="corporate-title">3 Adımda <span>Domain Al-Sat</span> Gelir Modeli</h1>
                    <p>1. DeedSa ile 2 kelimelik boşta .com portföyü keşfedin.<br>2. Namecheap üzerinden taban fiyata tescil edin.<br>3. Sedo.com üzerinde küresel alıcılara sunun.</p>
                </div>
            </div>
        </div>
    </main>
    ...
    <main class="container py-5 view-section" id="viewTerms">
        <div class="content-card">
            ...
            <p class="corporate-subtitle">DeedSa platformunu kullanmadan önce aşağıdaki koşulları okuyunuz.</p>
            <h3 class="section-header-blue"><i class="fa-solid fa-scale-balanced"></i> Hizmetin Kapsamı</h3>
            <p>DeedSa; alan adı keşfi, yapay zeka destekli analiz ve alan adı yatırım süreçlerine yardımcı olmak amacıyla sunulan bir bilgi ve araç platformudur. Platformda gösterilen sonuçlar bilgi ve araştırma amacı taşır.</p>
            <h3 class="section-header-blue"><i class="fa-solid fa-triangle-exclamation"></i> Sonuçların Kullanımı</h3>
            <p>Alan adı uygunluğu, tescil durumu, marka uygunluğu, fiyat, satış potansiyeli ve benzeri bilgiler değişebilir. DeedSa sonuçları garanti edilmiş yatırım, hukuk, finans veya marka danışmanlığı olarak değerlendirilmemelidir. Bir alan adını tescil etmeden veya satın almadan önce ilgili kayıt kuruluşu ve gerekli hukuki/marka kontrolleri kullanıcı tarafından ayrıca yapılmalıdır.</p>
            <h3 class="section-header-blue"><i class="fa-solid fa-user-check"></i> Kullanıcı Sorumluluğu</h3>
            <p>Kullanıcı, platformu yürürlükteki yasalara uygun kullanmayı ve üçüncü kişilerin haklarını ihlal edecek işlemler yapmamayı kabul eder. DeedSa'nın sunduğu araçların sonuçları üzerinden gerçekleştirilen üçüncü taraf işlemlerinden ilgili üçüncü taraf hizmet sağlayıcı sorumludur.</p>
            <h3 class="section-header-blue"><i class="fa-solid fa-rotate"></i> Değişiklikler</h3>
            <p>DeedSa, hizmetlerin yapısını ve bu koşulların içeriğini gerektiğinde güncelleyebilir. Güncel metin bu sayfada yayımlanır.</p>
        </div>
    </main>

    <main class="container py-5 view-section" id="viewAffiliate">
        <div class="content-card">
            <h1 class="corporate-title">Affiliate <span>Gelir</span> Bildirimi</h1>
            <p class="corporate-subtitle">DeedSa'nın üçüncü taraf bağlantıları hakkında şeffaflık bildirimi.</p>
            <div class="pro-callout-box">
                <h5 class="fw-bold mb-2"><i class="fa-solid fa-handshake me-2 text-primary"></i>Affiliate bağlantıları kullanıyoruz</h5>
                <p class="mb-0">DeedSa bazı üçüncü taraf hizmetlerine yönlendirme yapan affiliate (iş ortaklığı) bağlantıları kullanabilir. Bu bağlantılardan biri üzerinden kayıt, satın alma veya başka bir uygun işlem gerçekleştiğinde DeedSa komisyon veya benzeri bir gelir elde edebilir. Bu durum kullanıcıya sunulan hizmetin fiyatını değiştirmek zorunda değildir.</p>
            </div>
            <h3 class="section-header-blue"><i class="fa-solid fa-link"></i> Kullanılan iş ortakları</h3>
            <ul>
                <li><strong>Namecheap:</strong> alan adı tescili için yönlendirme bağlantısı.</li>
                <li><strong>Sedo:</strong> alan adı satış ve pazaryeri hizmetleri için yönlendirme bağlantısı.</li>
            </ul>
            <p>Affiliate bağlantısı kullanmak zorunlu değildir. Kullanıcı dilerse ilgili hizmet sağlayıcının kendi web sitesini bağımsız olarak ziyaret edebilir.</p>
        </div>
    </main>
    ...
    <main class="container py-5 view-section" id="viewPrivacy">
        <div class="content-card">
            ...
            <p class="corporate-subtitle">DeedSa'nın temel veri işleme ve gizlilik yaklaşımı.</p>
            <h3 class="section-header-blue"><i class="fa-solid fa-key"></i> Gemini API Anahtarı</h3>
            <p>DeedSa'nın mevcut tasarımında kullanıcı tarafından girilen Gemini API anahtarı tarayıcının localStorage alanında tutulur. Site metninde belirtildiği üzere anahtar DeedSa veritabanına kaydedilmez. Kullanıcı API anahtarını istediği zaman site üzerinden silebilir.</p>
            <h3 class="section-header-blue"><i class="fa-solid fa-database"></i> İşlenen Bilgiler</h3>
            <p>Alan adı analizi sırasında kullanıcı tarafından girilen niş/kategori ve API anahtarı, ilgili isteğin gerçekleştirilmesi amacıyla uygulamanın backend'ine gönderilebilir. Gemini istekleri, kullanıcının sağladığı API anahtarı kullanılarak ilgili Google Gemini API hizmetine iletilir.</p>
            <h3 class="section-header-blue"><i class="fa-solid fa-globe"></i> Üçüncü Taraf Hizmetler</h3>
            <p>DeedSa; Google Gemini, Namecheap ve Sedo gibi üçüncü taraf hizmetlerine bağlantılar veya teknik entegrasyonlar içerebilir. Bu hizmetlerin kendi gizlilik politikaları ve kullanım koşulları ayrıca geçerlidir.</p>
            <h3 class="section-header-blue"><i class="fa-solid fa-shield-halved"></i> Güvenlik</h3>
            <p>DeedSa, uygulama seviyesinde güvenlik başlıkları ve istek korumaları kullanır. Bununla birlikte internet üzerinden yapılan hiçbir aktarımın mutlak güvenlik garantisi verilemez.</p>
            <h3 class="section-header-blue"><i class="fa-solid fa-envelope"></i> Güncellemeler</h3>
            <p>Bu politika hizmetin teknik yapısı veya yürürlükteki gereklilikler değiştikçe güncellenebilir.</p>
        </div>
    </main>
    ...
    <script>
        ...
        function runPitchbook() {
            ...
            document.getElementById('toolPitchResults').innerHTML = `<div class="p-3 bg-light rounded-3 border small"><h6 class="fw-bold text-primary mb-2">${val} - Strateji:</h6><p class="mb-0">Hedef kitle ve ilk 3 ay reklam planı simüle edildi.</p></div>`;
        }
                            ...
                            <div class="investment-card">
                                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mt-2 mt-md-0">
                                        ...
                                        <a href="https://namecheap.pxf.io/c/7702316/1632743/5618" target="_blank" class="btn btn-register"><i class="fa-solid fa-cart-shopping me-1"></i> Hemen Al</a>
                                    </div>
                                </div>
