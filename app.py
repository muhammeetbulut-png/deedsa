    ...
    <header class="top-navbar">
        <div class="container-fluid d-flex justify-content-between align-items-center px-lg-3">
            <div class="d-flex align-items-center justify-content-between w-100 justify-content-lg-start">
                ...
                <!-- YENİ EKLENEN MOBİL MENÜ BUTONU (Sadece mobilde görünür) -->
                ...
                <!-- MASAÜSTÜ MENÜ (Orijinal kodunuz korundu, mobilde gizlenir) -->
            ...
            <div class="col-lg-10">
                <div class="content-card">
                    ...
                    <div class="step-card p-4 border rounded-3 bg-light">
                        ...
                        <a href="mailto:support.deedsa@gmail.com" class="fw-bold text-primary text-decoration-none fs-5">support.deedsa@gmail.com</a>
                    </div>
                </div>
            </div>
        </div>
